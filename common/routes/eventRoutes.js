...
router.get(
    '/:id/participants',
    authMid,
    partCtrl.getParticipants
);

router.get(
    '/:id/participants/me',
    authMid,
    partCtrl.getMySubscription
);
...
router.patch(
    '/:eventId/participants/:participantId/approval',
    authMid,
    adminMid,
    partCtrl.updateApprovalStatus
);
